...
describe('getDetails', function() {
  ...
  verify('0.52', { platform: 'linux', arch: 'x64' }, {
    archiveName: 'hugo_0.52_Linux-64bit.tar.gz',
    downloadLink: 'https://github.com/gohugoio/hugo/releases/download/v0.52/hugo_0.52_Linux-64bit.tar.gz',
    executableExtension: '',
    executableName: 'hugo_0.52_linux_amd64'
  });


  verify('0.52', { platform: 'darwin', arch: 'x64' }, {
    archiveName: 'hugo_0.52_macOS-64bit.tar.gz',
    downloadLink: 'https://github.com/gohugoio/hugo/releases/download/v0.52/hugo_0.52_macOS-64bit.tar.gz',
    executableExtension: '',
    executableName: 'hugo_0.52_darwin_amd64'
  });


  verify('0.52', { platform: 'win32', arch: 'x64' }, {
    archiveName: 'hugo_0.52_Windows-64bit.zip',
    downloadLink: 'https://github.com/gohugoio/hugo/releases/download/v0.52/hugo_0.52_Windows-64bit.zip',
    executableExtension: '.exe',
    executableName: 'hugo_0.52_windows_amd64.exe'
  });


  verify('0.52', { platform: 'win32', arch: 'x32' }, {
    archiveName: 'hugo_0.52_Windows-32bit.zip',
    downloadLink: 'https://github.com/gohugoio/hugo/releases/download/v0.52/hugo_0.52_Windows-32bit.zip',
    executableExtension: '.exe',
    executableName: 'hugo_0.52_windows_386.exe'
  });

  verify('extended_0.52', { platform: 'linux', arch: 'x64' }, {
    archiveName: 'hugo_extended_0.52_Linux-64bit.tar.gz',
    downloadLink: 'https://github.com/gohugoio/hugo/releases/download/v0.52/hugo_extended_0.52_Linux-64bit.tar.gz',
    executableExtension: '',
    executableName: 'hugo_extended_0.52_linux_amd64'
  });


  verify('extended_0.52', { platform: 'darwin', arch: 'x64' }, {
    archiveName: 'hugo_extended_0.52_macOS-64bit.tar.gz',
    downloadLink: 'https://github.com/gohugoio/hugo/releases/download/v0.52/hugo_extended_0.52_macOS-64bit.tar.gz',
    executableExtension: '',
    executableName: 'hugo_extended_0.52_darwin_amd64'
  });
  ...
  verify('extended_0.52', { platform: 'win32', arch: 'x64' }, {
    archiveName: 'hugo_extended_0.52_Windows-64bit.zip',
    downloadLink: 'https://github.com/gohugoio/hugo/releases/download/v0.52/hugo_extended_0.52_Windows-64bit.zip',
    executableExtension: '.exe',
    executableName: 'hugo_extended_0.52_windows_amd64.exe'
  });
  //END - Version 0.52
